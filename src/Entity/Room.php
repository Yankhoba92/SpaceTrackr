...
class Room
{
    ...
    private ?string $roomPicture = null;
    ...
    #[ORM\ManyToMany(targetEntity: Material::class, mappedBy: 'room')]
    ...
    public function setRoomPicture(?string $roomPicture): static
    {
